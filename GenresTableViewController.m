...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TrackModel *temp = [self.genresListItems objectAtIndex:[indexPath row]];
    [cell changeTitle:[temp trackname]];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        TrackModel *item = [self.genresListItems objectAtIndex:indexPath.row];
...
- (void)createAlertViewControllerWithKey:(NSInteger)key indexPath:(NSIndexPath *)indexPath {
    ...
    if (key == 2) {
        ...
        titleTrack = [[self.genresListItems objectAtIndex:indexPath.row] trackname];
    }
    //show alert
...
- (void)moveTo:(GenresAndSongTableViewCell *)cell {
    ...
    TrackModel *item = [self.genresListItems objectAtIndex:index.row];
    [self.genresListItems removeObject:item];
